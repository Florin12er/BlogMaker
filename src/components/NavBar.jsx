...
function NavBar() {
  ...
  const handleLogout = async (event) => {
    ...
    try {
      await axios.delete("https://blog-api-one-neon.vercel.app/user/logout", {
  ...
  return (
    <>
      ...
      {error && (
        <div
          className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-4 container mx-auto"
          role="alert"
        >
          {" "}
          {error}
